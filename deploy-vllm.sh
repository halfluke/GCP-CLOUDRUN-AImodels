...
ENV_VARS="MODEL_ID=${MODEL_ID},MAX_MODEL_LEN=${MAX_MODEL_LEN},DTYPE=${DTYPE},GPU_MEMORY_UTILIZATION=${GPU_MEMORY_UTILIZATION},VLLM_ENABLE_CUDA_COMPATIBILITY=${VLLM_ENABLE_CUDA_COMPATIBILITY},TOOL_CALL_PARSER=${TOOL_CALL_PARSER},ENABLE_AUTO_TOOL_CHOICE=true"
